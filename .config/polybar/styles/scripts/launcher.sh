...
FILE="$HOME/.config/polybar/styles/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/styles/scripts/rofi/launcher.rasi